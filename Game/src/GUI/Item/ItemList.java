	...
	implements MouseListener
{
	...
	private InventoryComponent itemComp;
	private EquipmentComponent equipComp;
	
	public ItemList(Entity player, int itemType)
	{
		itemComp = player.get(InventoryComponent.class);
		equipComp = player.get(EquipmentComponent.class);
		
		Inventory inventory = itemComp.getInventory();
